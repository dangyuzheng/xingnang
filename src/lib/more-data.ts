...
export const moreCities: CityGuide[] = [
  ...
  },
  {
    ...
    duration: "2-3天",
    budget: "人均800-1500元",
    transportHub: "天津站/天津滨海国际机场",
    tagline: "近代建筑博物馆，煎饼果子之城",
    coreTip: "五大道骑行是精华，意式风情街拍照打卡",
    funSpots: [
      { name: "五大道", tagline: "万国建筑博览", ticket: "免费(马车80元)", duration: "3-4小时", bestTime: "上午", tips: "骑行游览最佳，民园广场打卡", priority: "must" },
      { name: "意式风情街", tagline: "欧式建筑群", ticket: "免费", duration: "2-3小时", bestTime: "下午", tips: "拍照打卡，梁启超故居", priority: "must" },
      { name: "古文化街", tagline: "津门故里", ticket: "免费", duration: "2-3小时", bestTime: "上午", tips: "泥人张、杨柳青年画", priority: "must" },
      { name: "天津之眼", tagline: "摩天轮地标", ticket: "50元", duration: "30分钟", bestTime: "傍晚", tips: "夜景更美，提前网上订票", priority: "niche" },
    ],
    food: [
      { name: "煎饼果子", pricePerPerson: "10-15元", howToEat: "绿豆面，加馃箅儿", pitfall: "南楼煎饼最正宗" },
      { name: "狗不理包子", pricePerPerson: "60-80元", howToEat: "十八个褶，猪肉大葱", pitfall: "本地人不去，游客打卡" },
      { name: "耳朵眼炸糕", pricePerPerson: "5-10元", howToEat: "糯米外皮，豆沙馅", pitfall: "古文化街总店" },
      { name: "麻花", pricePerPerson: "20-40元", howToEat: "什锦馅，酥脆", pitfall: "十八街麻花" },
    ],
    foodAreas: [
      { name: "南市食品街", location: "南门外大街", bestTime: "午餐", direction: "天津小吃" },
      { name: "西北角", location: "红桥区", bestTime: "早餐", direction: "煎饼果子" },
    ],
    shopping: [
      { name: "滨江道", category: "mall", duration: "2-3小时", highlight: "天津最繁华商业街", forWho: "购物" },
    ],
    pitfalls: [
      { category: "scenic", content: "狗不理包子本地人不吃，游客打卡" },
      { category: "traffic", content: "早晚高峰拥堵，地铁方便" },
      { category: "general", content: "春秋风大，带外套" },
    ],
    itinerary: {
      easy: [
        { label: "Day1", morning: ["五大道"], afternoon: ["意式风情街"], evening: ["天津之眼"], walkLevel: "约1.5万步", transport: "地铁+骑行", nearbyFood: "南市食品街" },
        { label: "Day2", morning: ["古文化街"], afternoon: ["滨江道"], evening: ["返程"], walkLevel: "约1万步", transport: "地铁", nearbyFood: "西北角" },
      ],
      intense: [
        { label: "Day1", morning: ["五大道"], afternoon: ["意式风情街→古文化街"], evening: ["天津之眼"], walkLevel: "约2万步", transport: "地铁+骑行", nearbyFood: "南市食品街" },
        { label: "Day2", morning: ["鼓楼"], afternoon: ["老城厢"], evening: ["滨江道"], walkLevel: "约1.5万步", transport: "地铁", nearbyFood: "西北角" },
        { label: "Day3", morning: ["海河游船"], afternoon: ["解放北路"], evening: ["返程"], walkLevel: "约1万步", transport: "船+地铁", nearbyFood: "海河沿线" },
      ],
    },
    packingList: [
      { name: "舒适步行鞋", category: "clothing", required: true },
      { name: "外套", category: "clothing", required: true },
      { name: "充电宝", category: "electronics", required: true },
    ],
    nearbyFrom: ["北京"],
    nearbyDistance: "高铁30分钟",
    holidayWarning: "五大道节假日人多",
    holidayAlternative: "意式风情街人相对少",
  },
  {
    id: "chengde",
    name: "承德",
    ...
    duration: "2-3天",
    budget: "人均800-1500元",
    transportHub: "承德站/承德普宁机场",
    tagline: "避暑山庄，皇家园林",
    coreTip: "避暑山庄+外八庙是精华，夏季避暑胜地",
    funSpots: [
      { name: "避暑山庄", tagline: "皇家园林", ticket: "130元", duration: "半天", bestTime: "上午", tips: "中国四大名园之一，世界文化遗产", priority: "must" },
      { name: "外八庙", tagline: "藏传佛教寺庙群", ticket: "80元(联票)", duration: "3-4小时", bestTime: "下午", tips: "普陀宗乘之庙(小布达拉宫)", priority: "must" },
      { name: "磬锤峰", tagline: "丹霞地貌", ticket: "50元", duration: "3-4小时", bestTime: "上午", tips: "索道上下，俯瞰承德", priority: "niche" },
    ],
    food: [
      { name: "承德凉粉", pricePerPerson: "10-15元", howToEat: "豌豆凉粉，酸辣", pitfall: "南营子大街" },
      { name: "鲜花玫瑰饼", pricePerPerson: "15-25元", howToEat: "玫瑰馅，酥皮", pitfall: "特产手信" },
      { name: "南沙饼", pricePerPerson: "10-20元", howToEat: "白糖青红丝馅", pitfall: "百年老字号" },
    ],
    foodAreas: [
      { name: "南营子大街", location: "市中心", bestTime: "午餐/晚餐", direction: "本地小吃" },
    ],
    shopping: [
      { name: "南营子大街", category: "old_street", duration: "1-2小时", highlight: "商业步行街", forWho: "散步" },
    ],
    pitfalls: [
      { category: "scenic", content: "避暑山庄很大，建议租电瓶车" },
      { category: "traffic", content: "景点间距离远，建议包车" },
      { category: "general", content: "夏季凉爽，带薄外套" },
    ],
    itinerary: {
      easy: [
        { label: "Day1", morning: ["避暑山庄"], afternoon: ["外八庙"], evening: ["南营子大街"], walkLevel: "约2万步", transport: "公交+步行", nearbyFood: "南营子大街" },
        { label: "Day2", morning: ["磬锤峰"], afternoon: ["返程"], evening: ["市区"], walkLevel: "约1.5万步", transport: "索道+包车", nearbyFood: "市区" },
      ],
      intense: [
        { label: "Day1", morning: ["避暑山庄"], afternoon: ["外八庙"], evening: ["南营子大街"], walkLevel: "约2.5万步", transport: "公交+步行", nearbyFood: "南营子大街" },
        { label: "Day2", morning: ["磬锤峰"], afternoon: ["普宁寺"], evening: ["市区"], walkLevel: "约2万步", transport: "索道+包车", nearbyFood: "市区" },
        { label: "Day3", morning: ["金山岭长城"], afternoon: ["返程"], evening: ["沿途"], walkLevel: "约2万步", transport: "包车", nearbyFood: "沿途" },
      ],
    },
    packingList: [
      { name: "舒适步行鞋", category: "clothing", required: true },
    ...
    nearbyFrom: ["北京"],
    nearbyDistance: "自驾2小时/高铁1小时",
    holidayWarning: "避暑山庄节假日人多",
    holidayAlternative: "磬锤峰人少",
  },
  {
    id: "qinhuangdao",
    name: "秦皇岛",
    ...
    duration: "2-3天",
    budget: "人均800-1500元",
    transportHub: "秦皇岛站/北戴河站",
    tagline: "渤海之滨，避暑胜地",
    coreTip: "北戴河看海，山海关看长城，阿那亚拍照",
    funSpots: [
      { name: "北戴河", tagline: "海滨浴场", ticket: "免费", duration: "半天", bestTime: "上午/傍晚", tips: "老虎石公园，鸽子窝看日出", priority: "must" },
      { name: "山海关", tagline: "天下第一关", ticket: "40元", duration: "3-4小时", bestTime: "上午", tips: "长城起点，古城墙", priority: "must" },
      { name: "阿那亚", tagline: "网红社区", ticket: "免费(部分收费)", duration: "半天", bestTime: "下午", tips: "孤独图书馆，白色礼堂", priority: "niche" },
    ],
    food: [
      { name: "海鲜", pricePerPerson: "100-200元", howToEat: "皮皮虾、螃蟹、扇贝", pitfall: "海鲜市场买，饭店加工" },
      { name: "四条包子", pricePerPerson: "30-50元", howToEat: "猪肉大葱馅", pitfall: "山海关老字号" },
      { name: "桲椤叶饼", pricePerPerson: "10-15元", howToEat: "桲椤叶包裹，菜肉馅", pitfall: "山海关特色" },
    ],
    foodAreas: [
      { name: "海鲜市场", location: "北戴河", bestTime: "午餐/晚餐", direction: "海鲜加工" },
    ],
    shopping: [
      { name: "北戴河商业街", category: "old_street", duration: "1-2小时", highlight: "特产+纪念品", forWho: "散步" },
    ],
    pitfalls: [
      { category: "scenic", content: "北戴河旺季住宿贵，提前订" },
      { category: "food", content: "海鲜先问价，防宰客" },
      { category: "traffic", content: "景点间距离远，建议包车" },
      { category: "general", content: "夏季防晒，带泳衣" },
    ],
    itinerary: {
      easy: [
        { label: "Day1", morning: ["北戴河"], afternoon: ["阿那亚"], evening: ["海鲜市场"], walkLevel: "约1万步", transport: "包车", nearbyFood: "海鲜市场" },
        { label: "Day2", morning: ["山海关"], afternoon: ["返程"], evening: ["四条包子"], walkLevel: "约1.5万步", transport: "包车", nearbyFood: "四条包子" },
      ],
      intense: [
        { label: "Day1", morning: ["北戴河"], afternoon: ["阿那亚"], evening: ["海鲜市场"], walkLevel: "约1.5万步", transport: "包车", nearbyFood: "海鲜市场" },
        { label: "Day2", morning: ["山海关"], afternoon: ["老龙头"], evening: ["北戴河"], walkLevel: "约2万步", transport: "包车", nearbyFood: "四条包子" },
        { label: "Day3", morning: ["鸽子窝"], afternoon: ["老虎石"], evening: ["返程"], walkLevel: "约1万步", transport: "包车", nearbyFood: "北戴河" },
      ],
    },
    packingList: [
      { name: "泳衣", category: "clothing", required: true },
      { name: "防晒霜", category: "clothing", required: true },
      { name: "舒适步行鞋", category: "clothing", required: true },
      { name: "充电宝", category: "electronics", required: true },
    ],
    nearbyFrom: ["北京"],
    nearbyDistance: "高铁2小时",
    holidayWarning: "北戴河旺季人多，住宿贵",
    holidayAlternative: "阿那亚人相对少",
  },
  {
    id: "xianyang",
    name: "咸阳",
    ...
    duration: "1-2天",
    budget: "人均500-1000元",
    transportHub: "咸阳站/咸阳秦都站",
    tagline: "秦都故址，汉唐遗风",
    coreTip: "咸阳博物馆+乾陵+茂陵，西安出发半日游",
    funSpots: [
      { name: "咸阳博物馆", tagline: "秦汉文物", ticket: "免费", duration: "2-3小时", bestTime: "上午", tips: "西汉兵马俑，彩绘俑", priority: "must" },
      { name: "乾陵", tagline: "武则天墓", ticket: "100元", duration: "3-4小时", bestTime: "上午", tips: "唐高宗与武则天合葬墓", priority: "must" },
      { name: "茂陵", tagline: "汉武帝陵", ticket: "80元", duration: "2-3小时", bestTime: "上午", tips: "霍去病墓，马踏匈奴", priority: "niche" },
    ],
    food: [
      { name: "咸阳锅盔", pricePerPerson: "5-10元", howToEat: "厚实面饼，夹辣子", pitfall: "传统面食" },
      { name: "汇通面", pricePerPerson: "15-25元", howToEat: "扯面，油泼辣子", pitfall: "汇通夜市" },
      { name: "乾县豆腐脑", pricePerPerson: "8-12元", howToEat: "嫩豆腐，酸辣", pitfall: "乾县特色" },
    ],
    foodAreas: [
      { name: "汇通夜市", location: "秦都区", bestTime: "夜宵", direction: "面食小吃" },
    ],
    shopping: [
      { name: "人民路", category: "old_street", duration: "1-2小时", highlight: "商业步行街", forWho: "散步" },
    ],
    pitfalls: [
      { category: "scenic", content: "乾陵/茂陵距离远，建议包车" },
      { category: "traffic", content: "西安咸阳间地铁方便" },
      { category: "general", content: "春秋风大，带外套" },
    ],
    itinerary: {
      easy: [
        { label: "Day1", morning: ["咸阳博物馆"], afternoon: ["乾陵"], evening: ["汇通夜市"], walkLevel: "约1.5万步", transport: "包车", nearbyFood: "汇通夜市" },
      ],
      intense: [
        { label: "Day1", morning: ["咸阳博物馆"], afternoon: ["茂陵"], evening: ["汇通夜市"], walkLevel: "约1.5万步", transport: "包车", nearbyFood: "汇通夜市" },
        { label: "Day2", morning: ["乾陵"], afternoon: ["永泰公主墓"], evening: ["返程"], walkLevel: "约2万步", transport: "包车", nearbyFood: "乾县" },
      ],
    },
    packingList: [
      { name: "舒适步行鞋", category: "clothing", required: true },
    ...
    nearbyFrom: ["西安"],
    nearbyDistance: "高铁30分钟/地铁直达",
    holidayWarning: "乾陵节假日人多",
    holidayAlternative: "茂陵人少",
  },
  {
    id: "baoji",
    name: "宝鸡",
    ...
    duration: "2-3天",
    budget: "人均600-1200元",
    transportHub: "宝鸡站/宝鸡南站",
    tagline: "青铜器之乡，法门寺圣地",
    coreTip: "法门寺+太白山+青铜器博物馆，西安出发2小时",
    funSpots: [
      { name: "法门寺", tagline: "佛指舍利", ticket: "100元", duration: "半天", bestTime: "上午", tips: "唐代地宫，佛指舍利", priority: "must" },
      { name: "太白山", tagline: "秦岭主峰", ticket: "90元", duration: "1天", bestTime: "全天", tips: "拔仙台，高山湖泊", priority: "must" },
      { name: "青铜器博物馆", tagline: "青铜之都", ticket: "免费", duration: "2-3小时", bestTime: "上午", tips: "何尊，西周青铜器", priority: "niche" },
    ],
    food: [
      { name: "岐山臊子面", pricePerPerson: "15-25元", howToEat: "酸辣，薄筋光", pitfall: "岐山正宗" },
      { name: "擀面皮", pricePerPerson: "10-15元", howToEat: "筋道，酸辣", pitfall: "宝鸡特色" },
      { name: "豆花泡馍", pricePerPerson: "15-20元", howToEat: "豆花+馍，汤鲜", pitfall: "早餐" },
    ],
    foodAreas: [
      { name: "经二路", location: "渭滨区", bestTime: "午餐/晚餐", direction: "本地小吃" },
    ],
    shopping: [
      { name: "经二路", category: "old_street", duration: "1-2小时", highlight: "商业步行街", forWho: "散步" },
    ],
    pitfalls: [
      { category: "scenic", content: "太白山海拔高，注意高反" },
      { category: "traffic", content: "法门寺距离远，建议包车" },
      { category: "general", content: "太白山温差大，带厚外套" },
    ],
    itinerary: {
      easy: [
        { label: "Day1", morning: ["法门寺"], afternoon: ["青铜器博物馆"], evening: ["经二路"], walkLevel: "约1.5万步", transport: "包车", nearbyFood: "经二路" },
        { label: "Day2", morning: ["太白山"], afternoon: ["返程"], evening: ["沿途"], walkLevel: "约2万步", transport: "包车", nearbyFood: "沿途" },
      ],
      intense: [
        { label: "Day1", morning: ["法门寺"], afternoon: ["青铜器博物馆"], evening: ["经二路"], walkLevel: "约1.5万步", transport: "包车", nearbyFood: "经二路" },
        { label: "Day2", morning: ["太白山"], afternoon: ["太白山"], evening: ["山下住宿"], walkLevel: "约3万步", transport: "包车+索道", nearbyFood: "山下" },
        { label: "Day3", morning: ["太白山"], afternoon: ["返程"], evening: ["沿途"], walkLevel: "约2万步", transport: "包车", nearbyFood: "沿途" },
      ],
    },
    packingList: [
      { name: "舒适步行鞋", category: "clothing", required: true },
    ...
    nearbyFrom: ["西安"],
    nearbyDistance: "高铁1小时",
    holidayWarning: "法门寺节假日人多",
    holidayAlternative: "青铜器博物馆人少",
  },
];
